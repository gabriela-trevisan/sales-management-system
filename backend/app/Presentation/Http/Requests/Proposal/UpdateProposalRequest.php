 ...
 * 
 * Valida os dados para atualização de uma proposta existente.
...
class UpdateProposalRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'issue_date' => ['sometimes', 'required', 'date', 'date_format:Y-m-d'],
            'expiration_date' => ['sometimes', 'required', 'date', 'date_format:Y-m-d', 'after:issue_date'],
            'notes' => ['nullable', 'string', 'max:5000'],
            'status' => ['sometimes', 'required', 'string', Rule::in(['draft', 'sent', 'approved', 'rejected', 'expired'])],
